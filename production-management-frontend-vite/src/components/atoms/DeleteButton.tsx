...
export interface DeleteButtonProps extends Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, 'children'> {
  /**
   * Permission required to show/delete the button
...
/**
 * Reusable Delete Button component following atomic design principles
